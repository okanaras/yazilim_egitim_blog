        ...
        <x-slot:body>
            <form action="" method="get">
                <div class="row">
                    ...
                    <div class="col-3 my-2">
                        <input type="text" class="form-control" value="{{ request()->get('slug') }}" name="slug" placeholder="Slug">
                    </div>
                    <div class="col-3 my-2">
                        <input type="text" class="form-control" value="{{ request()->get('description') }}" name="description" placeholder="description">
                    </div>
                    <div class="col-3 my-2">
                        <input type="text" class="form-control" value="{{ request()->get('order') }}" name="order" placeholder="Order">
                    </div>
                    <div class="col-3 my-2">
                    ...
                    <div class="col-3 my-2">
                        <select class="js-states form-control" name="user_id" tabindex="-1" style="display: none; width: 100%">
                    ...
                    <div class="col-6 mb-2 d-flex">
                        ...
                        <button type="submit" class="btn btn-warning w-50">Filtreyi Temizle</button>
                    </div>
                    <hr>
                </div>
            </form>
